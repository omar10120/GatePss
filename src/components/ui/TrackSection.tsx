        ...
        <section id="info" className="py-20 px-4 bg-white">
            <div className="container mx-auto">
                <div className='flex flex-col p-8 md:p-16 lg:p-24 mx-auto rounded-xl justify-center items-center gap-4 md:gap-6 bg-gradient-to-b from-[#0571B6] to-[#003658] text-center'>
                    <h1 className="text-3xl md:text-4xl lg:text-5xl text-white font-medium leading-tight capitalize font-['Tajawal']" style={{ fontFamily: 'Tajawal' }}>{t('services.GetFast')}</h1>
                    ...
                    <Link
                        ...
                        className="inline-flex items-center bg-[#00B09C] justify-center gap-2 text-white px-8 md:px-12 py-3 md:py-4 rounded-full font-medium text-lg md:text-xl lg:text-2xl transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
